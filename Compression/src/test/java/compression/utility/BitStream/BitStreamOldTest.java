...
class BitStreamOldTest {
    ...
    void getNBits() {
        ...
        Assertions.assertEquals(BitUtil.bits2Int("111111110000"), actualNbits);
    }
    ...
    void getNBitsTwice() {
        ...
        Assertions.assertEquals(BitUtil.bits2Int("1111111"), actualNbits);

        actualNbits = bitStream.getNextNBitsAsInteger(9);

        Assertions.assertEquals(BitUtil.bits2Int("100000000"), actualNbits);
    }
    ...
    void getAll16Bits() {
        ...
        Assertions.assertEquals(BitUtil.bits2Int("1111111100000000"), actualNbits);
    }

    @Test
    void getTooManyBits() {
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> bitStream.getNextNBitsAsInteger(17));
    }

    @Test
    void getIllegalAmountBits() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> bitStream.getNextNBitsAsInteger(0));
    }
